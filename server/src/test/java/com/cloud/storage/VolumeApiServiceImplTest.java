...
public class VolumeApiServiceImplTest {
    ...
    public void assignVolumeWhereUserDoesNotHaveAccessToNewAccountThrows() throws Exception {
        ...
        doThrow(new PermissionDeniedException("Access check failed")).when(accountManagerMock).checkAccess(any(Account.class), nullable(AccessType.class), any(Boolean.class), same(accounts.second()));
    ...
    public void assignVolumeWhereUserDoesNotHaveAccessToOldAccountThrows() throws Exception {
        ...
        doThrow(new PermissionDeniedException("Access check failed")).when(accountManagerMock).checkAccess(any(Account.class), nullable(AccessType.class), any(Boolean.class), same(accounts.first()));
    ...
    private Pair<AccountVO, AccountVO> setupAccountsForVolumeAssignment() {
        ...
        when(accountManagerMock.finalizeOwner(any(Account.class), anyString(), anyLong(), nullable(Long.class))).thenReturn(newAccount);
