...
public class VirtualNetworkApplianceManagerImplTest {
    ...
    public void testUpdateSite2SiteVpnConnectionState() throws Exception{
        ...
        Site2SiteCustomerGatewayVO gw = new Site2SiteCustomerGatewayVO("Testing gateway", 1L, 1L, "192.168.50.15", "Guest List", "ipsecPsk", "ikePolicy", "espPolicy", 1L, 1L, true, true, false, "ike", "123456", "auto");
