...
public class NetworkACLServiceTest extends TestCase {
    ...
    public void testCreateACLItem() throws Exception {
        ...
        Mockito.when(
            _networkAclMgr.createNetworkACLItem(Matchers.anyInt(), Matchers.anyInt(), Matchers.anyString(), Matchers.anyList(), Matchers.anyList(), Matchers.anyInt(), Matchers.anyInt(),
